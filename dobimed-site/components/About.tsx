                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div>
                        ...
                        <div className="space-y-4 text-lg text-slate-600 leading-relaxed">
                            <p>
                                Основана през **1978 година**, <span
                                className="font-bold text-slate-800">Добимед М ООД</span> има десетилетия опит в
                                поддръжката на медицинска техника.
                            </p>
                            <p>
                                През 2006 г. нашата база е напълно обновена и модернизирана по проект на **Дружество за
                                болнично партньорство "Шафхаузен - Добрич" (Швейцария)**.
                            </p>
                            <p>
                                Това партньорство гарантира, че работим по най-високите европейски стандарти за
                                качество, чистота и технологична обезпеченост.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
                            <div
                                className="flex flex-col items-center text-center p-4 bg-white rounded-xl shadow-sm border border-slate-100">
                    ...
                    <div className="relative h-96 rounded-2xl overflow-hidden shadow-2xl border-4 border-white">
                        {/* Увери се, че пътят е /images/swiss-plaque.jpg */}
                        <img
